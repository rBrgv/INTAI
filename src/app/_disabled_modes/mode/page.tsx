        ...
        <div className="group">
          <Card className="h-full flex flex-col transition-all duration-200 group-hover:shadow-lg group-hover:border-[var(--primary)]">
            ...
            <div className="flex flex-col gap-2 mt-4">
              <Link
                href="/college/login"
                className="w-full inline-flex items-center justify-center text-white font-medium text-sm gap-1 bg-[var(--primary)] rounded px-4 py-2 hover:bg-[var(--primary-dark)] transition-colors"
              >
